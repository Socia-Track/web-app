        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-12">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed" style={{ fontFamily: '"Mona Sans", "Helvetica Neue", Helvetica, Arial, sans-serif' }}>
      ...
      <section id="pricing" className="py-20 px-6 sm:px-8 lg:px-12">
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-8" style={{ fontFamily: '"Mona Sans", "Helvetica Neue", Helvetica, Arial, sans-serif' }}>
