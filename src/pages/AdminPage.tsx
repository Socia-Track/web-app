    ...
    return (
      <div className="flex h-screen items-center justify-center bg-background">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Error Loading Admin Panel</h2>
                        ...
                        <tr key={request.id} className="border-b border-gray-300 hover:bg-gray-100">
                          ...
                          <td className="p-4">
                            <Badge 
                              variant="outline"
                              className={
                                request.status === 'approved' ? 'text-gray-900 border-gray-900' :
                                request.status === 'rejected' ? 'text-gray-600 border-gray-300' : 
                            ...
                            {request.status === 'pending' ? (
                              <div className="flex gap-2">
                                <Button
                                  ...
                                  variant="outline"
                                  className="border-gray-900 text-gray-900 hover:bg-gray-100 hover:text-gray-900"
                                >
              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      {allUsers.map((user) => (
                        <tr key={user.id} className="border-b border-gray-300 hover:bg-gray-200/50">
                          <td className="p-4">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={confirmApproval} variant="outline" className="border-gray-900 text-gray-900 hover:bg-gray-100 hover:text-gray-900">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button 
                ...
                className="border-gray-300 text-gray-600 hover:bg-gray-200 hover:text-gray-900 disabled:opacity-50"
              >
                <X className="h-3 w-3 mr-1" />
                Reject Request
              </Button>
