      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 max-w-4xl">
            ...
            <div className="mb-6 sm:mb-8">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  onClick={() => navigate(-1)}
                  className="mb-4 text-sm sm:text-base bg-[#00D9A3] hover:bg-[#00D9A3]/90 text-gray-900 font-medium transition-all"
                >
            ...
            >
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-100 p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="tokenAddress" className="text-[#1F2937]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="tokenSymbol" className="text-[#1F2937]">
                        Token Symbol *
                      </Label>
                      <Input
                        id="tokenSymbol"
                    ...
                    <div>
                      <Label htmlFor="tokenDecimals" className="text-[#1F2937]">
                        Token Decimals
                      </Label>
                      <Input
                        id="tokenDecimals"
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, tokenDecimals: e.target.value }))}
                        className="mt-2 bg-white border-gray-200 text-[#1F2937]"
                      />
                      <p className="text-xs text-[#6B7280] mt-1">
                        Usually 18 for standard ERC-20 tokens
                      </p>
                    </div>
                  </div>
