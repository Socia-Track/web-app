    ...
    <DashboardLayout>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
            {[
              ...
              <motion.div
                ...
                className="group relative rounded-lg border bg-gray-100 p-6 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <motion.div
                      ...
                      className="w-11 h-11 rounded-lg bg-gray-200 flex items-center justify-center group-hover:bg-gray-300 transition-colors relative"
                    >
                      <div className="text-gray-900">{kpi.icon}</div>
                      <motion.div
                    ...
                    <div className="px-2 py-1 rounded-full text-xs bg-gray-200 border border-gray-300">
                  ...
                  <div className="text-xs text-gray-600/70">{kpi.change}</div>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            className="rounded-xl border border-gray-300 p-6 bg-gray-100 relative overflow-hidden"
          >
              ...
              {campaigns.length === 0 ? (
                <div className="text-center py-12">
                  <motion.div
                    animate={{ y: [0, -10, 0] }}
                    transition={{ duration: 2, repeat: Infinity }}
                    className="w-16 h-16 rounded-full bg-gray-200/50 flex items-center justify-center mx-auto mb-4"
                  >
                    <Target className="text-gray-600" size={32} />
                  </motion.div>
                  <p className="text-gray-900 font-medium mb-2">No campaigns yet</p>
                ...
                <div className="space-y-3">
                  {campaigns.slice(0, 5).map((campaign, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-4 p-4 rounded-lg border bg-gray-200/30 hover:bg-gray-200/50 hover:border-primary/20 transition-all cursor-pointer group"
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-xs text-gray-600/70">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              style={{ transformStyle: "preserve-3d" }}
              className="group rounded-xl border bg-gray-100 p-6 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden relative"
            >
              <div className="absolute top-0 right-0 w-20 h-20 bg-gray-200/30 rounded-full blur-xl" />
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  >
                    <Twitter className="text-gray-900" size={20} />
                  </motion.div>
                  <h3 className="text-lg font-bold text-gray-900">Top Platform</h3>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Twitter</span>
                    <span className="text-2xl font-bold text-gray-900">{Math.floor(kpis.totalAttributions * 0.6)}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Discord</span>
                    <span className="text-xl font-bold text-gray-700">{Math.floor(kpis.totalAttributions * 0.4)}</span>
                  </div>
            ...
            <motion.div
              ...
              className="group rounded-xl border bg-gray-100 p-6 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden relative"
            >
              <div className="absolute bottom-0 left-0 w-20 h-20 bg-gray-200/30 rounded-full blur-xl" />
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">Live Status</h3>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-gray-900/60 rounded-full animate-pulse" />
                    <span className="text-sm text-gray-600">Blockchain sync: 100%</span>
                  </div>
                  <div className="pt-2 border-t border-gray-300">
            ...
            <motion.div
              ...
              className="group rounded-xl border bg-gray-100 p-6 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden relative"
            >
              <div className="absolute top-0 left-0 w-20 h-20 bg-gray-200/30 rounded-full blur-xl" />
