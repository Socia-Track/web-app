          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
            <Card className="bg-card">
              ...
              <CardContent className="pb-4">
                <p className="text-3xl font-bold text-white">{filteredAttributions.length}</p>
                <p className="text-xs text-gray-500 mt-1">of {attributions.length} total</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card">
              ...
              <CardContent className="pb-4">
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <p className="text-xs text-green-400">+5% vs last week</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card">
              ...
              <CardContent className="pb-4">
                <p className="text-3xl font-bold text-white">{totalValue.toFixed(2)} ETH</p>
                <p className="text-xs text-gray-500 mt-1">≈ ${(totalValue * 2500).toLocaleString()}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card">
              ...
              <CardContent className="pb-4">
                <p className="text-3xl font-bold text-white">{uniquePlatforms.length}</p>
                <p className="text-xs text-gray-500 mt-1">{platformNames}</p>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent className="p-4 md:p-6">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-white/10 hover:bg-white/5">
                      <TableHead className="text-gray-400 px-4 py-3 whitespace-nowrap">Social Post</TableHead>
                      <TableHead className="text-gray-400 px-4 py-3 whitespace-nowrap">Transaction</TableHead>
                      <TableHead className="text-gray-400 px-4 py-3 whitespace-nowrap">Value</TableHead>
                      <TableHead className="text-gray-400 px-4 py-3 whitespace-nowrap">Confidence</TableHead>
                      <TableHead className="text-gray-400 px-4 py-3 whitespace-nowrap">Time Gap</TableHead>
                      <TableHead className="text-gray-400 px-4 py-3 whitespace-nowrap">Keywords</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                      ...
                      >
                        <TableCell className="px-4 py-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-300 mb-1 line-clamp-2 max-w-xs">
                        ...
                        <TableCell className="px-4 py-4">
                          <div>
                            ...
                            >
                              <code className="text-xs text-gray-400">{attribution.transaction.hash}</code>
                        ...
                        <TableCell className="px-4 py-4">
                          <p className="text-white font-semibold">{attribution.transaction.value}</p>
                        </TableCell>
                        <TableCell className="px-4 py-4">
                        ...
                        <TableCell className="px-4 py-4">
                          <p className="text-sm text-gray-400">{attribution.timeGap}</p>
                        </TableCell>
                        <TableCell className="px-4 py-4">
              ...
              {filteredAttributions.length === 0 && (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-400 mb-2">No attributions found</p>
