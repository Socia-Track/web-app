      ...
      <div className="container mx-auto px-8 py-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-700">Track and manage social media posts for attribution</p>
            </div>
            <div className="flex gap-3">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="bg-gray-100 border-gray-300">
                  <DialogHeader>
                    <DialogTitle className="text-gray-900">Add Social Post</DialogTitle>
                    <DialogDescription>
          ...
          {posts.length === 0 ? (
            <div className="text-center py-16 rounded-xl border border-gray-300 bg-gray-100">
              <MessageSquare className="mx-auto mb-4 text-gray-500" size={64} />
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No social posts yet</h3>
              <p className="text-gray-600 mb-6">Start tracking social media posts for attribution analysis</p>
