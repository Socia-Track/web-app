      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-7xl">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-base text-gray-400">Manage your account settings and preferences</p>
            </div>
                ...
                {activeTab === "profile" && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="rounded-lg bg-card p-4 border border-white/6">
                        <div className="text-2xl font-bold text-white">{userStats.totalCampaigns}</div>
                      ...
                      <div className="rounded-lg bg-card p-4 border border-white/6">
                        <div className="text-2xl font-bold text-white">${userStats.totalRevenue.toFixed(2)}</div>
                        <div className="text-xs text-gray-400 mt-1">Revenue</div>
                      </div>
                      <div className="rounded-lg bg-card p-4 border border-white/6">
                        <div className="text-2xl font-bold text-white">{userStats.memberSince ? new Date(userStats.memberSince).getFullYear() : '2024'}</div>
                        <div className="text-xs text-gray-400 mt-1">Member Since</div>
                      </div>
                    </div>

                    {/* Profile Form */}
                    <div className="rounded-xl bg-card p-6 border border-white/6">
                      ...
                      <div className="space-y-5">
                        <div className="grid md:grid-cols-2 gap-5">
                          <div>
                            ...
                            <Input 
                              ...
                              className="mt-2 bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all duration-200" 
                            />
                          </div>
                          <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                          ...
                          <div>
                            <Label htmlFor="accountType" className="text-gray-300 text-sm font-medium">Account Type</Label>
                            <Input 
                              id="accountType" 
                        ...
                        <div className="flex items-center gap-3 pt-4">
                          ...
                          <Button variant="ghost" className="text-gray-300 hover:bg-white/5">Cancel</Button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === "notifications" && (
                <div className="rounded-xl bg-card p-6 border border-white/6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 transition-all">
                      <div className="flex-1">
                        <p className="font-medium text-white text-base">Email Notifications</p>
                        <p className="text-sm text-gray-400 mt-1">Receive email alerts for new attributions</p>
                      </div>
                      <Switch checked={emailNotifications} onCheckedChange={setEmailNotifications} />
                    </div>
                    <div className="flex items-center justify-between p-5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 transition-all">
                      <div className="flex-1">
                        <p className="font-medium text-white text-base">Weekly Reports</p>
                        <p className="text-sm text-gray-400 mt-1">Receive weekly attribution summary reports</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    <div className="flex items-center justify-between p-5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 transition-all">
                      <div className="flex-1">
                        <p className="font-medium text-white text-base">Campaign Updates</p>
                        <p className="text-sm text-gray-400 mt-1">Get notified about campaign milestones</p>
                      </div>
                      <Switch defaultChecked />
                    </div>
              ...
              {activeTab === "security" && (
                <div className="space-y-6">
                  ...
                  <div className="rounded-xl bg-card p-6 border border-white/6">
                    ...
                    <div className="space-y-5">
                      <div>
                        <Label htmlFor="currentPassword" className="text-gray-300 text-sm font-medium">Current Password</Label>
                        <Input 
                          id="currentPassword" 
                          type="password" 
                  ...
                  <div className="rounded-xl bg-card p-6 border border-white/6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 transition-all">
                        <div className="flex-1">
                          <p className="font-medium text-white text-base">Enable 2FA</p>
